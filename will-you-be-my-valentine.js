let messages = ["Por que escolheu essa opção -_-?", "Ainda está insistindo?", "Você nâo me ama mais?", "Pense novamente!", "Você pode se arrepender!", "Ultima chance!", "Por que você ainda esta aqui?", "Vai partir o meu coraçãozinho 💔"];
let noCount = 0;
...
function acceptLove() {
    document.getElementById("valentine").innerHTML = `
        ...
        <div class="question">EBAAAAAAAAAA EU TE AMO DEMAIS MINHA VIDA MAIS LINDA E PERFEITA DO MUNDO ❤️</div>
    `;
    launchConfetti();
    startHeartRain();
}
